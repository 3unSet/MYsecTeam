...
public class ContainerAPI {
    ...
    //获取单个docker容器实例信息
    public  static Container getContainerInfo(String host,String imageId){
        List<Container> containers=getAllContainer(host);
        for (Container container:containers){
            if(container.getId().equals(imageId)){
                return container;
            }
        }
        return null;
    ...
    //启动一个容器
    public static String createContain(String composeFilePath,int index) throws IOException, InterruptedException {
        try {
            String contaierName=composeFilePath+"_"+index;
     ...
     */
    public static  String createContain(RemoteHost remoteHost, String remoteComposeDirectory,int index){
        String containerName=remoteComposeDirectory+"_"+index;
            try {
                // 使用 JSch 创建 SSH 会话
        ...
        public static void createContain(){
    ...
    //关闭远程的docker
    public static void stopContainer(RemoteHost remoteHost,String remoteComposeDirectory){
        try {
